...
namespace System.Text.Json
{
    public partial class Utf8JsonWriter_Fetch
    {
        ...
        private void WriteStringMinimized(ReadOnlySpan<char> escapedPropertyName, ReadOnlySpan<char> escapedValue)
        {
            ...
            WriteStringValue(ref buffer, escapedValue, ref idx);
        ...
        private void WriteStringValue(ref Span<byte> buffer, ReadOnlySpan<char> escapedValue, ref int idx)
        {
        ...
        private void WriteStringValue(ref Span<byte> buffer, ReadOnlySpan<byte> escapedValue, ref int idx)
        {
            if (buffer.Length <= idx)
            {
                AdvanceAndGrow(ref buffer, ref idx);
            ...
            CopyLoop(ref buffer, escapedValue, ref idx);
