...
namespace System.Text.Json
{
    public partial class Utf8JsonWriter_Final
    {
        ...
        private void WriteNumberValueMinimized_new(long value)
        {
            ...
            bool result = Utf8Formatter.TryFormat(value, _buffer.AsSpan(_buffered), out int bytesWritten);
            Debug.Assert(result);
        ...
        private void WriteNumberValueMinimized(long value)
        {
            ...
            bool result = Utf8Formatter.TryFormat(value, output.Slice(_buffered), out int bytesWritten);
            Debug.Assert(result);
            _buffered += bytesWritten;
        }
