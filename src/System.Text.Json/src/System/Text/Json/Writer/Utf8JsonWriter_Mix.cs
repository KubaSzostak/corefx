...
namespace System.Text.Json
{
    ...
    public partial class Utf8JsonWriter_Mix
    {
        ...
        /// </remarks>
        public Utf8JsonWriter_Mix(IBufferWriter<byte> bufferWriter, JsonWriterState state = default)
        {
        ...
        public Utf8JsonWriter_Mix(JsonWriterState state = default)
        {
            _output = null;
            _array = new byte[256];
            _buffered = 0;
        ...
        public void Clear()
        {
            ...
            {
                Span<byte> lastSpan = _array.AsSpan(0, _buffered);
                lastSpan.Clear();
            }
