...
namespace System.Text.Json
{
    ...
    /// </remarks>
    public sealed partial class Utf8JsonWriter2 : IDisposable
#if BUILDING_INBOX_LIBRARY
        , IAsyncDisposable
#endif
    {
        ...
        /// </exception>
        public Utf8JsonWriter2(IBufferWriter<byte> bufferWriter, JsonWriterOptions options = default)
        {
        ...
        /// </exception>
        public Utf8JsonWriter2(Stream utf8Json, JsonWriterOptions options = default)
        {
            if (utf8Json == null)
