...
namespace System.Text.Json
{
    public static partial class JsonSerializer
    {
        ...
        /// Write the provided value into the provided writer as a JSON value.
        /// </summary>
        public static void WriteProperty(Utf8JsonWriter writer, JsonEncodedText utf8PropertyName, object value, Type type, JsonSerializerOptions options = null)
        {
            VerifyValueAndType(value, type);
            WriteCore(writer, utf8PropertyName, value, type, options);
        }

        /// <summary>
        /// Write the provided value into the provided writer as a JSON value.
        /// </summary>
        public static void WriteProperty<TValue>(Utf8JsonWriter writer, JsonEncodedText utf8PropertyName, TValue value, JsonSerializerOptions options = null)
        {
            WriteCore(writer, utf8PropertyName, value, typeof(TValue), options);
        }
        ...
        private static void WriteCore(Utf8JsonWriter writer, JsonEncodedText propertyName, object value, Type type, JsonSerializerOptions options)
        {
            if (options == null)
            {
                options = JsonSerializerOptions.s_defaultOptions;
            ...
            else
            {
                ...
                Write(writer, propertyName, - 1, options, ref state);
            }
